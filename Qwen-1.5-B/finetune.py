...
model_name = "Qwen/Qwen2.5-1.5B"  #"microsoft/phi-2" #"TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T"
tokenizer = AutoTokenizer.from_pretrained(model_name)
model = AutoModelForCausalLM.from_pretrained(
    model_name,
    device_map="auto",
...
training_args = TrainingArguments(
    ...
    num_train_epochs=5,
    learning_rate=2e-5,
    output_dir="./finetuned_qwen1.5b_newthis_spaced_Pro_Astar",
